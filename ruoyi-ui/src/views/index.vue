  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>JUST学生综合后台管理系统</h2>
        <p>
          不用说了，就是被学校学工处胁迫的呢，冲他丫的
        </p>
        <p>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 个人博客：<el-link
                href="http://www.mr8god.cn"
                target="_blank"
                >https://www.mr8god.cn</el-link
              >
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> 个人联系方式（微信）：<a
                href="javascript:;"
                >jcw17696748602</a
              >
            </p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <img
              src="https://i.loli.net/2021/04/25/rsLVgb2IGxyh7kz.jpg"
              alt="donate"
              width="100%"
            />
